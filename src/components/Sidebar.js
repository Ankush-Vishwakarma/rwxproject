...
import arrowButton from '../assets/Arrow 1.svg';
import SidebarRouting from './SidebarRouting'; // Import the new routing component
    ...
    <>
      ...
      <Box sx={{ display: "flex" }}>
        ...
        <Box sx={{ flexGrow: 1, p: 3 }}>
          <SidebarRouting /> {/* Use the new routing component */}
        </Box>
      </Box>
    </>
  );
